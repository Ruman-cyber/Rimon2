...
ua = "[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748058;FBDM/{density=3.0,width=1080,height=1776};FBLC/es_LA;FBCR/VIVA;FBMF/Sony;FBBD/Sony;FBPN/com.facebook.katana;FBDV/C6906;FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;]"
...
def approval():
  ...
  id = "MRM".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Ruman-cyber/Approval.txt/blob/main/App').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('am start https://wa.me/+881909043700?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
...
def sex():
	...
	fbdv = random.choice(["Infinix Smart 8", "Infinix Note 30 Pro", "Infinix Note 30", "Infinix Hot 30i", "Infinix Hot 30", "Infinix Note 12 Pro", "Infinix Smart 7", "Infinix Hot 20i", "Infinix Hot 20S", "Infinix Note 12 G96", "Redmi K20", "Infinix Hot 12i", "Infinix Hot 12", "Redmi 5A", "Infinix Hot 12 Play", "Infinix Hot 10S", "Infinix Hot 10 Play", "Infinix Note 11 Pro", "Infinix Smart 5 Pro", "Infinix Note 12 2023", "Infinix Hot 20S", "Infinix Note 12 G96", "Infinix Hot 12i", "Infinix Hot 12", "Infinix Note 12 G88", "Infinix Smart 6"])
